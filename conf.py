...
BLOG_AUTHOR = "Remi Rampin"  # (translatable)
BLOG_TITLE = "NYU ViDA - Visualization and Data Analytics"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://vida-nyu.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://vida-nyu.github.io/"
BLOG_EMAIL = "remi.rampin@nyu.edu"
BLOG_DESCRIPTION = "Website for the ViDA group."  # (translatable)
